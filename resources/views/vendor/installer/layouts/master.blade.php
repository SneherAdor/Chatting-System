...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif QbLogin</title>
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header" style="background-color: #02923f">
                    <h1 class="header__title">@yield('title')</h1>
                </div>
                <ul class="step">
                    <li class="step__divider" style="background-color: #02923f"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::final') }}">
                        <i class="step__icon" aria-hidden="true">1</i>
                    </li>
